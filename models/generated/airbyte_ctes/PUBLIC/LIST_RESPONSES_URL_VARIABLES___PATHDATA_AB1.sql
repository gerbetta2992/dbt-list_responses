...
select
    ...
    {{ json_extract_scalar('__PATHDATA', ['type'], ['type']) }} as TYPE,
    {{ json_extract_scalar('__PATHDATA', ['value'], ['value']) }} as VALUE,
    {{ json_extract_scalar('__PATHDATA', ['key'], ['key']) }} as KEY,
    _AIRBYTE_AB_ID,
    _AIRBYTE_EMITTED_AT,
