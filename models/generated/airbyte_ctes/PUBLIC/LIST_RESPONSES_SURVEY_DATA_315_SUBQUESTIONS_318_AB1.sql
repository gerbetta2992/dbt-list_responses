...
select
    ...
    {{ json_extract('table_alias', adapter.quote('318'), ['10359'], ['10359']) }} as {{ adapter.quote('10359') }},
    {{ json_extract('table_alias', adapter.quote('318'), ['10358'], ['10358']) }} as {{ adapter.quote('10358') }},
    _AIRBYTE_AB_ID,
    _AIRBYTE_EMITTED_AT,
...
where 1 = 1
and {{ adapter.quote('318') }} is not null
