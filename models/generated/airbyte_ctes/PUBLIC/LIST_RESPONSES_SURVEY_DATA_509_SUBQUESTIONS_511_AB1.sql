...
select
    ...
    {{ json_extract('table_alias', adapter.quote('511'), ['10734'], ['10734']) }} as {{ adapter.quote('10734') }},
    {{ json_extract('table_alias', adapter.quote('511'), ['10735'], ['10735']) }} as {{ adapter.quote('10735') }},
    _AIRBYTE_AB_ID,
    _AIRBYTE_EMITTED_AT,
...
where 1 = 1
and {{ adapter.quote('511') }} is not null
