...
select
    ...
    {{ json_extract('table_alias', adapter.quote('808'), ['11845'], ['11845']) }} as {{ adapter.quote('11845') }},
    {{ json_extract('table_alias', adapter.quote('808'), ['11846'], ['11846']) }} as {{ adapter.quote('11846') }},
    _AIRBYTE_AB_ID,
    _AIRBYTE_EMITTED_AT,
...
where 1 = 1
and {{ adapter.quote('808') }} is not null
