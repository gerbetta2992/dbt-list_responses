...
select
    ...
    {{ json_extract_scalar('__CONTACT', ['type'], ['type']) }} as TYPE,
    {{ json_extract_scalar('__CONTACT', ['value'], ['value']) }} as VALUE,
    {{ json_extract_scalar('__CONTACT', ['key'], ['key']) }} as KEY,
    _AIRBYTE_AB_ID,
    _AIRBYTE_EMITTED_AT,
